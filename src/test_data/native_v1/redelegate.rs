...
/// Represents native redelegation sample.
#[derive(Clone, Debug)]
...
// Generate a native redelegate sample for every possible combination of parameters
...
/// Returns valid native redelegate samples.
...
/// Returns invalid native redelegate samples.
